...
st.markdown(f"<h4 style='color:#F2E2C4; font-size:20px;'> Moving your cursor over a province will reveal the average price of REGULAR gas for {last_month:%b-%Y} </h4>", unsafe_allow_html = True)
